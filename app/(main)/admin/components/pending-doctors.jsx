                    ...
                    <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                      ...
                      <div className="flex items-center gap-2 self-end md:self-auto">
                        <Badge
                          ...
                          {/* so here by clicking on the button to see details we will see a dialogue box */}
                        <Button
                          variant="outline"
                          size="sm"
      ...
      {selectedDoctor && (
        <Dialog open={!!selectedDoctor} onOpenChange={handleCloseDialog}>
          <DialogContent className="max-w-3xl my-10 max-h-[75vh] overflow-y-auto ">
            ...
            <div className="space-y-6 py-4">
              ...
              <div className="flex flex-col md:flex-row gap-6">
                ...
                <div className="space-y-1 flex-1">
                  ...
                  <p className="text-base font-medium text-white">
                     {/* "PPP" is a formatting pattern that produces a readable long-form date, like: May 1st, 2024 */}
            ...
            {/* i was showing this bar laoder from reacr-spinner package */}
